...
var DNSClient = /** @class */ (function () {
    function DNSClient(communication, persistence) {
        this.responsePromises = {};
        this.communication = communication;
        this.persistence = persistence;
    }
    DNSClient.prototype.start = function (userInput) {
        return __awaiter(this, void 0, void 0, function () {
            var mappedRecordType, transactionID, packet, responsePromise;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mappedRecordType = this.mapRecordType(userInput.recordType);
                        if (!mappedRecordType) {
                            console.error('Invalid record type provided.');
                            return [2 /*return*/];
                        }
                        transactionID = Math.floor(Math.random() * 65535);
                        packet = PacketGenerator_1.PacketGenerator.createPacket(userInput.domain, mappedRecordType, transactionID);
    ...
    DNSClient.prototype.mapRecordType = function (recordType) {
        var typeMap = {
            'A': 'A',
            'AAAA': 'AAAA',
            'CNAME': 'CNAME'
    ...
    DNSClient.prototype.queryFlow = function (packet) {
